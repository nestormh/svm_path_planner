...
public class DlgConfiguraClt extends JDialog implements MouseListener {
    ...
    private void initComponents() {
        ...
        GroupLayout pnlVideoLayout = new GroupLayout(pnlVideo);
        pnlVideo.setLayout(pnlVideoLayout);
        pnlVideoLayout.setHorizontalGroup(
            pnlVideoLayout.createParallelGroup(GroupLayout.LEADING)
            .add(pnlVideoLayout.createSequentialGroup()
                .addContainerGap()
                .add(pnlVideoLayout.createParallelGroup(GroupLayout.LEADING)
                    .add(lblIP)
                    .add(txtIP, GroupLayout.PREFERRED_SIZE, 141, GroupLayout.PREFERRED_SIZE)
                    .add(lblCaching)
                    .add(spnCaching, GroupLayout.PREFERRED_SIZE, 62, GroupLayout.PREFERRED_SIZE))
