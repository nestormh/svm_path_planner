...
public interface InterfazRMI extends Remote {
    ...
    /**
     * Devuelve si el control del vehículo está disponible o se ha desactivado en
     * el servidor
     * @return Devuelve si se activó o no el control en el servidor
     * @throws RemoteException
     */
    public boolean isControlActivo() throws RemoteException;
}
