...
public class ControlZoom {
    ...
    /**
     * Obtiene los objetos de comunicación con los puerto
     * @return Devuelve los objetos de comunicación con los puertos
     */
    public ZoomConnection[] getPuerto() {
        return puerto;
    }

    /**
     * Obtiene el zoom para la cámara i
     * @return Devuelve el zoom para la cámara i
     */
