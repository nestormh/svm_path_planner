...
double eval_cubic_spline(double u,double xa,double xb,double xc,double xd);
double eval_quadr_spline(double u,double xa,double xb,double xc);
double eval_ctrom_spline(double u,double xa,double xb,double xc,double xd);
double eval_quadr_bezier_spline(double u,double xa,double xb,double xc);
double eval_cubic_bezier_spline(double u,double xa,double xb,double xc,double xd);

/*
 * Retrun a string denoting the spline type
 */
char *CNsplinetype(int splinetype)
{
   char *plot;
 ...
 */
void CNcreate_spline(double *xarr,int npts,double* xs,int* nspts,int ndiv,int splinetype,int closed)
{
   switch (splinetype) {
   case CN_SP_CUBICB   :
 ...
 */
void CNmake_cubic_B_spline(double* xarr,int npts,double* xs,int* nspts,int ndiv)
{
   double u,du;
   int    i,j;
 ...
 */
void CNmake_closed_cubic_B_spline(double* xarr,int npts,double* xs,int* nspts,int ndiv)
{
   double u, du;
   int    i,j;
 ...
 */
void CNmake_double_cubic_B_spline(double* xarr,int npts,double* xs,int* nspts,int ndiv)
{
   double u, du;
   int    i, j;
 ...
 *    All Control points are doubled
 */
void CNmake_double_closed_cubic_B_spline(double* xarr,int npts,double* xs,int* nspts,int ndiv)
{
   double u, du;
   int    i, j;
 ...
 */
static double eval_cubic_spline(double u,double xa,double xb,double xc,double xd)
 ...
 *    Control points are doubled only at the end-points
 */
void CNmake_quadr_B_spline(double* xarr,int npts,double* xs,int* nspts,int ndiv)
{
   double u, du;
   int    i, j;
 ...
 *    Control points are "folded over" at the end-points
 */
void CNmake_closed_quadr_B_spline(double* xarr,int npts,double* xs,int* nspts,int ndiv)
{
   double u, du;
   int    i, j;
 ...
 */
static double eval_quadr_spline(double u,double xa,double xb,double xc)
{
   double c;
 ...
 *    Control points are doubled only at the end-points
 */
void CNmake_ctrom_spline(double* xarr,int npts,double* xs,int* nspts,int ndiv)
{
   double u, du;
   int    i, j;
 ...
 *    Control points are doubled only at the end-points
 */
void CNmake_closed_ctrom_spline(double* xarr,int npts,double* xs,int* nspts,int ndiv)
{
   double u, du;
   int    i,j;
 ...
 */
static double eval_ctrom_spline(double u,double xa,double xb,double xc,double xd)
 ...
 *    Control points are doubled only at the end-points
 */
void CNmake_quadr_bezier_spline(double* xarr,int npts,double* xs,int* nspts,int ndiv)
{
 ...
 *    Spline curve approximates the real curve
 */
void CNmake_closed_quadr_bezier_spline(double* xarr,int npts,double* xs,int* nspts,int ndiv)
{
   double xm1, xm2, xm3, u, du;
   int    i,j;
 ...
 *    Control points are doubled only at the end-points
 */
void CNmake_cubic_bezier_spline(double* xarr,int npts,double* xs,int* nspts,int ndiv)
{
 ...
 *    Spline curve approximates the real curve
 */
void CNmake_closed_cubic_bezier_spline(double* xarr,int npts,double* xs,int* nspts,int ndiv)
{
   double xm1, xm2, xm3, xm4, u, du;
   int    i,j;
 ...
 */
static double eval_quadr_bezier_spline(double u,double xa,double xb,double xc)
 ...
 */
static double eval_cubic_bezier_spline(double u,double xa,double xb,double xc,double xd)
{
   double c;
