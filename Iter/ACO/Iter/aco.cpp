...
/**************************************************
Devuelve 1 o 0 en función de la que exista un borde
en el la imagen de entrada en las coordenadas 
indicadas.
***************************************************/
...
/************************************************************************
 Busca los estados iniciales de los agentes. La búsqueda se hace en los 
...
el punto de atracción y el rango de exploración.
**************************************************************/
