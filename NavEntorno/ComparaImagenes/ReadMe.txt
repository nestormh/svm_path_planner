...
AppWizard ha creado esta aplicación matchImagenes6.  

Este archivo incluye un resumen acerca del contenido de los archivos que
constituyen su aplicación matchImagenes6.


matchImagenes6.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado matchImagenes6.pch y un archivo de 
