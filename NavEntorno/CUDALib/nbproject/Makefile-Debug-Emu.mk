...
# C Compiler Flags
CFLAGS=-DUNIX -D_DEBUG -deviceemu --compiler-bindir=/usr/bin/gcc-4.3

# CC Compiler Flags
CCFLAGS=-DUNIX -D_DEBUG -deviceemu --compiler-bindir=/usr/bin/gcc-4.3
CXXFLAGS=-DUNIX -D_DEBUG -deviceemu --compiler-bindir=/usr/bin/gcc-4.3
...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Debug-Emu.mk dist/Debug-Emu/NVCC-Linux-x86/libcudalib.a

dist/Debug-Emu/NVCC-Linux-x86/libcudalib.a: ${OBJECTFILES}
	${MKDIR} -p dist/Debug-Emu/NVCC-Linux-x86
	${RM} dist/Debug-Emu/NVCC-Linux-x86/libcudalib.a
	${AR} rv ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libcudalib.a ${OBJECTFILES} 
	$(RANLIB) dist/Debug-Emu/NVCC-Linux-x86/libcudalib.a
