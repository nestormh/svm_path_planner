...
%    end
   ...
   j = 1;                           % Calcular los máximos comparando con su entorno
   ...
   greatest = max(fil(maximos));    % Seleccionar sólo aquellos máximos que sean del tamaño de un porcentaje del mayor
   factor = 0.33;
