   ...
   */
    ...
    */
	...
	switch (e.getEventType()) {
        ...
        toma = toma.substring(1, toma.lastIndexOf(" "));
		//System.out.println(toma);
        String toma2= toma.substring(toma.lastIndexOf(" "));
        //System.out.println(toma2);
        toma = toma.substring(1, toma.lastIndexOf(" ")).trim();
		        String toma3= toma.substring(toma.lastIndexOf(" "));
        //System.out.println(toma3);
        int identificador = Integer.parseInt(toma3.trim());
		int cuenta2 = Integer.parseInt(toma2.trim());
