...
*/
 public Dibujo(Recta[] rectas, Ultrasonido[] ultras, Carro carro) {    
...
*/
 ...
 {g.drawLine((int)(rectas[i].posicionInicio.x), s.height - (int)(rectas[i].posicionInicio.y) ,(int)(rectas[i].posicionFinal.x), s.height - (int)(rectas[i].posicionFinal.y));
 }
 /* dibujar carro */
