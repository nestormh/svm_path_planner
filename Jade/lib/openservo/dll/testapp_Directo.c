...
/*
AFHC 20100114
Modificamos para que haga enlace con libería en tiempo de compilación
*/
#include <string.h>
#include <stdio.h>
#include <stdbool.h>
...
int parse_data( char *argv[], int count, int len, unsigned char *data )
{
    int n;
