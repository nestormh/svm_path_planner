   ...
   */
    ...
    */
	...
	switch (e.getEventType()) {
		...
		String toma = new String(inputBuffer).trim();
//System.out.println("toma= " + toma);
      char[] destino = new char[25];
            inputBuffer.getChars(0,inputBuffer.length(), destino,0);
//for(int m = 0; m < destino.length; m++)
//{int h = (int)(destino[m]); 
// if (h!=0)
// System.out.println("char[" + m +  "]= " + destino[m] + "-----" + (int)(destino[m]) );
//}
		//messageAreaIn.append(toma);
		try{
		

		//System.out.println("**");
		//visual.fijaRadio(2,100,101);
		
      //  String toma1= toma.substring(toma.lastIndexOf(" ")).trim();
       //System.out.println("1" + toma1);
        //toma = toma.substring(0, toma.lastIndexOf(" "));
		//stem.out.println(toma);
        //String toma2= toma.substring(toma.lastIndexOf(" ")).trim();
       //System.out.println("2" + toma2);
        //toma = toma.substring(0, toma.lastIndexOf(" ")).trim();
	//	System.out.println("Queda=" + toma);
	//	        String toma3= toma.substring(toma.lastIndexOf(" "));
        //System.out.println("3" + toma3);
        //toma = toma.substring(0, toma.lastIndexOf(" ")).trim();
		//System.out.println("Queda=" + toma);
		        //String toma4= toma.substring(toma.lastIndexOf(" "));
        //System.out.println("4=" + toma4);
        
		
		int identificador = (int)(destino[0]);

		int cuenta2 = (int)(destino[1]);
		int cuenta1 = (int)(destino[2]);


		//int cuenta1 = Integer.parseInt(toma1.trim());
		System.out.println(identificador + " - " + cuenta2 + " - " + cuenta1); 
	if (identificador == 10)
	identificador = 13;

	visual.fijaRadio(identificador, cuenta2, cuenta1);
		} catch (Exception ep) {}
		break;
