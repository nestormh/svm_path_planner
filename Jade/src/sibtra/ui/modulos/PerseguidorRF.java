...
//			añadeAPanel(new SpinnerDouble(DireccionRF.this,"getConsignaDir",0,6,0.1), "Min Vel");
			...
			añadeAPanel(new LabelDatoFormato(PerseguidorRF.class,"getConsignaDirGrados","%6.2f º"), "Ang RF");
			añadeAPanel(new LabelDatoFormato(PerseguidorRF.class,"getDistancia","%6.2f m"), "Dist RF");
			añadeAPanel(new SpinnerDouble(this,"setvelCrucero",0.05,4,0.05), "Vel Crucero");
