...
AppWizard ha creado esta aplicación CapturaImagen.  

Este archivo incluye un resumen acerca del contenido de los archivos que
constituyen su aplicación CapturaImagen.


CapturaImagen.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado CapturaImagen.pch y un archivo de 
