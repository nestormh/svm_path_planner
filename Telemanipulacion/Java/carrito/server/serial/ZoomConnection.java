...
import carrito.cliente.Cliente;
 ...
 */
public class ZoomConnection implements SerialPortEventListener,
     ...
     */
    public ZoomConnection(SerialParameters parameters) {
    ...
    public ZoomConnection(String portName) {
    ...
    /**
     * Establece el zoom para la cámara
    ...
    public void setZoom(int zoom) {
        ...
        String valor = Integer.toHexString(zoom).toUpperCase();
        ...
        a[4] = (byte)'9';
        a[5] = (byte)'0';
        a[6] = (byte)valor.charAt(0);
        a[7] = (byte)valor.charAt(1);
        a[8] = (byte)valor.charAt(2);
        ...
        String checksum = Integer.toHexString(suma).toUpperCase();

        a[9] = (byte)checksum.charAt(checksum.length() - 2);
        a[10] = (byte)checksum.charAt(checksum.length() - 1);
