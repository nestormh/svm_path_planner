...
public class Constantes {
    ...
    public final static int CARRO_CENTRO = 5000;//32767;
    ...
    // Variables de configuración del Vehículo (por defecto todas son true)
    private boolean canFrenoEmergencia = true;
    private boolean canFreno = true;
    private boolean canDesfreno = true;
    private boolean canAvance = true;
    private boolean canRetroceso = true;
    private boolean canGiro = true;
    private boolean canInitVolante = true;
    private boolean canInitDesfreno = true;
    ...
    public void openServer() {
        ...
        File conf = new File("c:\\configsrv.dat");
        while (! conf.exists()) {
            saveServer();
        }
        ...
        try {
            ...
            canFrenoEmergencia = ois.readBoolean();
            canFreno = ois.readBoolean();
            canDesfreno = ois.readBoolean();
            canAvance = ois.readBoolean();
            canRetroceso = ois.readBoolean();
            canGiro = ois.readBoolean();
            canInitVolante = ois.readBoolean();
            canInitDesfreno = ois.readBoolean();
    ...
    public void saveServer() {
        ...
        try {
            ...
            oos.writeBoolean(canFrenoEmergencia);
            oos.writeBoolean(canFreno);
            oos.writeBoolean(canDesfreno);
            oos.writeBoolean(canAvance);
            oos.writeBoolean(canRetroceso);
            oos.writeBoolean(canGiro);
            oos.writeBoolean(canInitVolante);
            oos.writeBoolean(canInitDesfreno);
  ...
  public void setCanRetroceso(boolean canRetroceso) {
    this.canRetroceso = canRetroceso;
  }

  public void setCanInitVolante(boolean canInitVolante) {
    this.canInitVolante = canInitVolante;
  }

  public void setCanInitDesfreno(boolean canInitDesfreno) {
    this.canInitDesfreno = canInitDesfreno;
  }

  public void setCanGiro(boolean canGiro) {
    this.canGiro = canGiro;
  }

  public void setCanFrenoEmergencia(boolean canFrenoEmergencia) {
    this.canFrenoEmergencia = canFrenoEmergencia;
  }

  public void setCanFreno(boolean canFreno) {
    this.canFreno = canFreno;
  }

  public void setCanDesfreno(boolean canDesfreno) {
    this.canDesfreno = canDesfreno;
  }

  public void setCanAvance(boolean canAvance) {
    this.canAvance = canAvance;
  }
  ...
  public boolean isCanAvance() {
    return canAvance;
  }

  public boolean isCanDesfreno() {
    return canDesfreno;
  }

  public boolean isCanFreno() {
    return canFreno;
  }

  public boolean isCanFrenoEmergencia() {
    return canFrenoEmergencia;
  }

  public boolean isCanGiro() {
    return canGiro;
  }

  public boolean isCanInitDesfreno() {
    return canInitDesfreno;
  }

  public boolean isCanInitVolante() {
    return canInitVolante;
  }

  public boolean isCanRetroceso() {
    return canRetroceso;
  }
